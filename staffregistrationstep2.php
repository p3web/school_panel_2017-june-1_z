...
$(document).ready(function(){
    $('#checko').change(function() {
		...
		if($(this).prop("checked") == true){
			...
			$('#religion').val('Belief/Religion');
			$('#religion').css('color','#CCC');
		}
		else if($(this).prop("checked") == false){
			$("#religion").prop("readonly",false);
			$('#religion').val('');
			$('#religion').css('color','#000');
		}
		  ...
		  if( check_religion($religion) == "no"){
				...
				echo "<script type='text/javascript'>
        		 ...
        		 if(isset($_POST["mytext"]) && is_array($_POST["mytext"])){  
        			...
        			header('location:staffregistrationstep3.php');	
	...
	<div class="container-fluid">
        ...
        <h3  class="text-center">REGISTRATION</h3>
                ...
                <div class="col-sm-12 text-center" style="background-color:#FFF; margin-bottom:30px; margin-top:2em; padding-bottom:30px;">
                		...
                		<div class="row">
                        <div class="col-sm-4 text-left" style="margin-left:1.5%; margin-top:3.5%;"><span style=" font-weight:bold; font-size:1.2em; color:#71908a;">2. SPOKEN LANGUAGES & BELIEF</span>
                        </div>
                     ...
                     <input type="text" class="form-control inputfield" style="float:left; margin-left:1.5%; width:45%; " name="religion" id="religion" placeholder="Belief/Religion" value="<?php echo $religion; ?>" >
                              
                         <a href="#" style="margin-right:2em; " data-toggle="tooltip" data-placement="top" title="Can't find your belief, please read FAQ.">
                              <span style="font-size:20px; " class="glyphicon glyphicon-question-sign speccolor"  ></span> 
                              </a>
                    
                    
                         
                        <input   id="checko" type="checkbox" ><label style="clear:right;margin-right:9em">&nbsp;Don&apos;t want to answer</label>
                                 ...
                                 <br>
									...
									<div class="input_fields_wrap">
                                       ...
                                       <!-- <div><input type="text" name="mytext[]"></div>-->
                                        ...
                                        <div><input type="text" class="form-control inputfield" required style="clear:both; float:left; margin-left:1.5%; width:45%;" data-toggle="tooltip" data-placement="top" title="Can't find your Language, please read FAQ." name="mytext[]" id="language"  placeholder="Choose Language and Level*" value="<?php echo $language; ?>"  >
                                     ...
                                     <div id="maxlanerror"  style="color:red; clear:both; float:left; margin-bottom:0.5em; margin-left:1.5%;"></div>
                                          <button class="add_field_button btn btn-default loginbutton center-block" style="clear:both; width:35%; height:3em; background-color:#a3c366;">Add More Languages</button>   
                      ...
                      <span style="float:left;  margin-top:0.5em;">* Mandatory fields</span>
                            ...
                            <a href="staffregistrationstep1.php">
