						...
						die("ERROR: Data not inserted".mysql_error());
								...
								require("/home/ancestryatlas/public_html/phpmailertesting/PHPMailer_5.2.0/class.phpmailer.php");
									...
									<br><br> From: Ancestry Atlas
									 Thanks for signing up with Ancestry Atlas, powered by Cultural Infusion.
											  <br> ".$adminName." invited you to Ancestry Atlas
											  <br><br>Start your journey here!
											  <br><br>------------------------
											  <br>Username: ".$email." 
											  <br>------------------------
											  <br>Please click <a href='http://www.ancestryatlas.com/verifystudent.php?email=".$email."&token=".$token."'>here</a> to complete assessment
									...
									$mail->Body    = "
											  ...
											  <ol>
											  	<li>Activate this registration by selecting this <a href='http://www.ancestryatlas.com/verifystudent.php?email=".$email."&token=".$token."'>LINK</a></li>
                             ...
                             <br><br>
                              ...
                              <?php
									...
									if($resultteachers == TRUE){
										...
										echo "<table width='100%'  class='table-striped table-bordered'>";
										echo "<thead>";
										echo "<tr>";
										...
										*/
										...
										while ($rowj=mysql_fetch_array($resultteachers)){
											...
											*/
											...
											echo "<td  style='padding:1%;'>";
											echo '<a name="view" id="'.$rowj["studentemailid"].'" data-toggle="modal" data-target="#dataModal" class="view_data"> Click Here</a>';
											echo "</td>";
