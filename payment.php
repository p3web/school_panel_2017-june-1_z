            ...
            <div class="col-sm-8">
            	<div class="row">
                	<div class="col-sm-12 text-center welcome" style="font-size:1.500em; padding:3.250em 0em 3.250em 0em;" >
                           ...
                           Please Select the plan and proceed for the payment.<br>
			               <br>
                           
                           
                           <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
				<input type="hidden" name="cmd" value="_s-xclick">
				<input type="hidden" name="hosted_button_id" value="EETV7SSVY284A">
				<table align="center">
				<tr><td><input type="hidden" name="on0" value="Premiums payment">Premiums payment</td></tr><tr><td><select name="os0">
				    <option value="Small schools ( Up to 200 students )">Small schools ( Up to 200 students ) $0.01 AUD</option>
				    <option value="Medium schools ( 201-500 students )">Medium schools ( 201-500 students ) $400.00 AUD</option>
				    <option value="Large schools ( 501-1000 students a year )">Large schools ( 501-1000 students a year ) $600.00 AUD</option>
				</select> </td></tr>
				</table>
