...
<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		 ...
		 if(isset($_POST["mytext"]) && is_array($_POST["mytext"])){  
			...
			header('location:teamregistrationstep3.php');	
        ...
        <div class="row" >
            ...
            <br>
                ...
                <div class="col-sm-12 text-center" style="background-color:#FFF; margin-bottom:30px; margin-top:2em; padding-bottom:30px;">
                		...
                		<div class="row">
                        <div class="col-sm-4 text-left" style="margin-left:1.5%; margin-top:3.5%;"><span style=" font-weight:bold; font-size:1.2em; color:#71908a;">2. BELIEF & SPOKEN LANGUAGES</span>
                        </div>
                      ...
                      <span style="float:left;  margin-top:0.5em;">* Mandatory fields</span>
                            ...
                            <a href="teamregistrationstep1.php">
