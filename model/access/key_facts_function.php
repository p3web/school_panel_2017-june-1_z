...
class key_facts_func
{
    ...
    public static function count_Languages($id ,$name , $deptname = false){
        ...
        //print_r($A);
        $result = "Languages ".$A[0]['languagename']."(".$A[0]['count']."), ".$A[1]['languagename']."(".$A[1]['count'].") and ".$A[2]['languagename']."(".$A[2]['count'].") are the most $spoken languages in this $class";
        return $result ;
    ...
    public static function grandparents($id ,$name , $deptname = false){
            ...
            $result = "In total, people in this $class are from ".$A[0]['count']." different countries, which includes country of birth of all($staff, mother, father, grandparents )";
            return $result ;
    ...
    public static function Highest_number($id ,$name , $deptname = false){
            ...
            $result = "Highest number of language count spoken by a particular $staff ".$A[0]['count'].".";
            return $result ;
    ...
    public static function How_many_number ($id ,$name , $deptname = false){
            ...
            $result = "How many number  of $staff are not willing to revile their belief? ".$A[0]['count'];
            return $result ;
