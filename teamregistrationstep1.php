...
if (isset($_GET['u']) && !empty($_GET['u']) AND isset($_GET['t']) && !empty($_GET['t'])) {
    ...
    $queryp = "select orgid from teamadmin where teamemailid = '" . $email . "'";
    ...
    $query = "select orgname from organisationadmin where orgid = '" . $orgId . "'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ((empty($firstNameErr)) and (empty($lastNameErr)) and (empty($passErr)) and (empty($passConErr))) {
        ...
        header('location:teamregistrationstep2.php');
        ...
        <div class="row">
            ...
            <div class="col-sm-6 text-center">
                ...
                <div class="col-sm-12 text-center"
                    ...
                    <div class="row">
                        <div class="col-sm-4 text-left" style="margin-left:1.5%; margin-top:3.5%;"><span
                                style=" font-weight:bold; font-size:1.2em; color:#71908a;">1. PERSONAL DETAILS</span>
                        </div>
                        <div class="col-sm-4 text-center"><img src="images/mainlogo.png" alt="" title="" width="73"
                                                               height="73" class="loglogo" style="">
                        </div>
                        <div class="col-sm-4">
                        </div>
                    </div>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group form-inline">
                            ...
                            <input type="text" class="form-control inputfield"
                                   style="margin-left:1.5%; width:45%; background-color:#6f9693; color:#000;"
                        ...
                        <div class="form-group form-inline">
                            ...
                            <input type="text" class="form-control inputfield" style="margin-left:0%; width:45%;"
                        ...
                        <div class="form-group form-inline">
                            ...
                            <select required class="form-control inputfield" style="margin-left:1.5%; width:45%;"
                                ...
                                <option <?php if ($option == "others") echo "selected"; ?> value="others">Others
                                </option>
                            </select>
                        </div>
                        <div class="form-group form-inline">
                            ...
                            <select required class="form-control inputfield"
                                    style="float:left; margin-left:5.5%; width:45%;" name="age" id="age">
                        ...
                        // }else{
                        ?>
                        <button type="submit" class="btn btn-default loginbutton" title="NEXT"
                                style=" float:right; margin-right:2.5em; margin-top:3em; width:15%; height:6%;">NEXT
                        </button>
