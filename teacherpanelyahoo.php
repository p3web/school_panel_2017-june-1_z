...
<?php
	$adminid = $_SESSION['emailid']; 
		...
		function makecsv($data, $csvfilename,$scriptrun = null)		
		{
			...
			function makexls($data, $xlsfilename)		
		{
			$list = $data;

			$file = fopen($xlsfilename,"w");
  ...
  <link rel="stylesheet" type="text/css" href="css/style.css">
	...
	<script>
		$(function() {
			...
			$( "#gfmindiv" ).autocomplete({
			source: 'autocompletecountry.php'
			});
			
			$( "#gmmindiv" ).autocomplete({
			source: 'autocompletecountry.php'
			});
			...
			$( "#gffindiv" ).autocomplete({
			source: 'autocompletecountry.php'
			});
			
			$( "#gmfindiv" ).autocomplete({
			source: 'autocompletecountry.php'
			});
		});
	...
	<script>
		...
		$(function() {
			$( "#beliefreligionindiv" ).autocomplete({
			source: 'autocompletereligion.php'
			});
		});
	 ...
	 <script>
        $(document).ready(function(){
        	...
        	$('#checkoindiv').change(function() {
        		if($(this).prop("checked") == true){	
        			$("#beliefreligionindiv").prop("readonly",true);
        			$('#beliefreligionindiv').val('Belief/Religion');
        			$('#beliefreligionindiv').css('color','#CCC');
        			
        		}
        		else if($(this).prop("checked") == false){
        			$("#beliefreligionindiv").prop("readonly",false);
        			$('#beliefreligionindiv').val('');
        			$('#beliefreligionindiv').css('color','#000');
        		}
 ...
 function drawRegionsMap() {
        var data = google.visualization.arrayToDataTable([
			...
			$result1 = mysql_query($currentQuerry); 
				...
				makecsv($output, "regionmapdataout.csv", false);
			while($row = mysql_fetch_assoc($result)) { 
                          ...
                          <div class="tab-content">
                            <div id="students" class="tab-pane fade in active">
							 ...
							 <a href="studentform/AA_Printable form.pdf" target="_blank" title="please click here for printable vesion of student form"style="color:#000;float:right; font-weight:bold; text-decoration:underline;">Printable Form</a> 
                                ...
                                <a style="clear:both; float:right;" name="addindiv" id="addindiv" data-toggle="modal" data-target="#addindivdataModal" class="addindiv_data btn btn-success"> ADD</a>
                            ...
                            <div id="maps" class="tab-pane fade">
                              <br>
                          <div>
                              <div id="regions_div" style="float:left;" width='100%'></div>
				...
				?>
					...
					<a href="teacherreligonout.csv" id="CSVFILE">EXPORT To CSV</a> <br>
                            ...
                            <div id="export" class="tab-pane fade">
                             <script id="infogram_0_ancestryatlas-536" title="AncestryAtlas" src="//e.infogr.am/js/dist/embed.js?DlI" type="text/javascript"></script>
                              <br>
...
<!-- EDIT STUDENT MODAL  -->
 ...
 <div id="addindivdataModal" class="modal fade">  
      <div class="modal-dialog">  
           <div class="modal-content">  
                <div class="modal-header">  
                     <button type="button" class="close" data-dismiss="modal">&times;</button>  
                     <h4 class="modal-title" style="text-align:center; "font-weight:bold; ">Add Student Details</h4>  
                </div>  
                <div class="modal-body">  
                
                <form  method="post" id="addindiv_form" name="addindiv_form" class="form-horizontal">
                    <h3 style="padding: 1% 0%; background-color:#FE8885; color:#FFF; text-align:center;  border-radius: 8px;">PERSONAL DETAILS</h3>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="studentemailindiv">Email ID:</label>
                      <div class="col-sm-9">
                        <input type="email" class="form-control" id="studentemailindiv" name="studentemailindiv" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="firstnameindiv">First Name:</label>
                      <div class="col-sm-9">          
                        <input type="text" class="form-control" id="firstnameindiv" name="firstnameindiv" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="lastnameindiv">Last Name:</label>
                      <div class="col-sm-9">          
                        <input type="text" class="form-control" id="lastnameindiv" name="lastnameindiv" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="genderindiv">Gender:</label>
                      <div class="col-sm-9">          
                        <select name="genderindiv" id="genderindiv" class="form-control">  
                               <option value="male">Male</option>  
                               <option value="female">Female</option>
                               <option value="others">Others</option>
                          </select>
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="beliefreligionindiv">Belief/Religion:</label>
                      <div class="col-sm-9">          
                        <div class="col-sm-6" >
                            <input type="text" class="form-control" id="beliefreligionindiv" name="beliefreligionindiv" >
                        </div>
                        <div class="col-sm-6">
                            <input id="checkoindiv" type="checkbox" >
                            <label style="margin-top:0.5em">&nbsp;Don&apos;t want to answer</label>
                        </div>
                      </div>
                    </div> 
                    <h3 style="padding: 1% 0%; background-color:#FE8885; color:#FFF; text-align:center;  border-radius: 8px;">BIRTH COUNTRIES</h3>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="sbindiv">Student:</label>
                      <div class="col-sm-9">          
                        <input type="text" class="form-control" id="sbindiv" name="sbindiv" >
                      </div>
                    </div>
                    
                    <hr>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="mindiv">Mother:</label>
                      <div class="col-sm-9">          
                        <input type="text" class="form-control" id="mindiv" name="mindiv" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="gfmindiv">GrandFather:</label>
                      <div class="col-sm-9">          
                        <input type="text" class="form-control" id="gfmindiv" name="gfmindiv" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="gmmindiv">GrandMother:</label>
                      <div class="col-sm-9">          
                        <input type="text" class="form-control" id="gmmindiv" name="gmmindiv" >
                      </div>
                    </div>
                   
                    <hr>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="findiv">Father:</label>
                      <div class="col-sm-9">          
                        <input type="text" class="form-control" id="findiv" name="findiv" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="gffindiv">GrandFather:</label>
                      <div class="col-sm-9">          
                        <input type="text" class="form-control" id="gffindiv" name="gffindiv" >
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="gmfindiv">GrandMother:</label>
                      <div class="col-sm-9">          
                        <input type="text" class="form-control" id="gmfindiv" name="gmfindiv" >
                      </div>
                      
                      <!-- HIDEEEEEEEEEEEEEEEEEEEEEEEEEEEENNNNNNNNNNNNNNNNNNNNNNNNNN    KAROOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO-->
                        <input type="text" id="schoolindivdata" name="schoolindivdata" >
                      
                    </div>
                    
                          <br>
                    <input type="submit" name="updateindiv" id="updateindiv" value="Save" class="btn btn-success "  />
...
$('#addindiv_form').on("submit", function(event){  
           event.preventDefault();  
           if($('#studentemailindiv').val() == "")  
           {  
                alert("Email ID is required");  
           }  
           else if($('#firstnameindiv').val() == '')  
           {  
                alert("First Name is required");  
           }  
           else if($('#genderindiv').val() == '')  
           {  
                alert("Gender is required");  
           }  
           else if($('#beliefreligionindiv').val() == '')  
           {  
                alert("Belief/Religion is required");  
           }
           else if($('#sbindiv').val() == '')
           {
               alert("Student Birthplace is required");
           }
           else if($('#mindiv').val() == '')
           {
               alert("Mother's Birthplace is required");
           }
           else if($('#gfmindiv').val() == '')
           {
               alert("Grandfather (Mother's side) Birthplace is required");
           }
           else if($('#gmmindiv').val() == '')
           {
               alert("Grandmother (Mother's side) Birthplace is required");
           }
           else if($('#findiv').val() == '')
           ...
           else if($('#gffindiv').val() == '')
           {
               alert("Grandfather (Father's side) Birthplace is required");
           }
           else if($('#gmfindiv').val() == '')
           {
               alert("Grandmother (Father's side) Birthplace is required");
           }
           else  
           {  
               ...
               $.ajax({  
                     url:"validindivdata.php",  
                     method:"POST",  
                     data:$('#addindiv_form').serialize(),   
                     success:function(data){  
                          
                          
                          if(data == "No error"){
                             
                             alert("Hi I am here You can insert values now");
                             
                             //SECOND CALL
                            
                             $.ajax({
                             
                                     url:"insertindivstudentdetails.php",  
                                     method:"POST",  
                                     data:$('#addindiv_form').serialize(),   
                                     success:function(data){  
