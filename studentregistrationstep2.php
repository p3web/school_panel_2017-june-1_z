            ...
            <h3  class="text-center">REGISTRATION</h3>
                ...
                <div class="col-sm-12 text-center" style="background-color:#FFF; margin-bottom:30px; margin-top:2em; padding-bottom:30px;">
                     ...
                     <input type="text" class="form-control inputfield" style="float:left; margin-left:1.5%; width:45%; " name="religion" id="religion" placeholder="Belief/Religion" value="<?php echo $religion; ?>" >
                         ...
                         <a href="#" style="margin-right:2em; " data-toggle="tooltip" data-placement="top" title="Can't fjhhhind your belief, please read FAQ.">
                      ...
                      <span style="float:left;  margin-top:0.5em;">* Mandatory fields</span>
                            ...
                            <a href="studentregistrationstep1.php">
