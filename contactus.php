...
$combineErr="";
	...
	//EVERTHING IS OK NOW
	 if((empty($firstNameErr))  and (empty($emailErr)) and (empty($messageErr)) ){
						...
						$mail->AddAddress("info@ancestryatlas.com");                 
						$mail->addCC("rezza.m@culturalinfusion.org.au");
                ...
                <div class="col-sm-12 text-center" style="background-color:#FFF; margin-bottom:30px;  padding-bottom:30px;">
                       ...
                       <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                            ...
                            <div class="form-group form-inline" >
                             ...
                             <div class="form-group form-inline">
                            	<textarea class="form-control inputfield"  style="margin-left:1.5%; width:92%; resize: none;" rows="7" name="message" id="message" placeholder="Message*"><?php echo $message; ?></textarea>
