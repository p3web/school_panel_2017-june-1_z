...
.speccolor:hover{color:#BDE1DF !important;}
	...
	<script>
		...
		$(document).ready(function(){
			...
			source: 'autocompleteschools.php'
			});
		});
		 ...
		 //school organization name validation
		   if (empty($_POST["schoolName"])) {
			...
			while ($row=mysql_fetch_array($result))
			{
				...
				if(strtolower($schoolName) == strtolower($row["schoolname"])){
					$dataMatched = "yes";
		    ...
		    if( $dataMatched == "no"){
				$schoolOrgNameErr = "School name not found.";
				$combineErr = $combineErr."<br>".$schoolOrgNameErr;
				echo "<script type='text/javascript'>
					$(document).ready(function()
					{
						$('#school').css('background-color', '#ffb0b0');
					}); </script>";
	 ...
	 if((empty($firstNameErr)) and (empty($lastNameErr)) and (empty($emailErr)) and (empty($countryErr)) and (empty($schoolOrgNameErr)) and (empty($passErr)) and (empty($passConErr))  ){
		 ...
		 //require_once('functions.php');
			...
			$token = bin2hex($bytes);
				...
				if(!mysql_query("insert into school(schoolname, country, state, city, suburb, postcode,	adminemailid, firstname, lastname, password, token, status,	dateofregistration) values('$schoolOrgName','$country','$stateProvince','$city','$suburb', '$postcode','$email','$firstName','$lastName','$hashAndSaltedPassword','$token','pending','$datetime')",$con)){
						...
						$ccvv = emailbodytoschooladmin($adminid,$email,$token);
						$mail->Body    = "".$ccvv."";
	...
	<div class="container-fluid">
        ...
        <div class="row" >
            ...
            <div class="col-sm-6 text-center">
                <br> <br> <br>
             <h3  class="text-center">SCHOOL REGISTRATION</h3>
                       ...
                       <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                            ...
                            <div class="form-group form-inline">
                             ...
                             <input type="text" class="form-control inputfield" style="margin-left:1.5%; width:17%;" name="postcode" id="postcode" placeholder="Postcode" value="<?php echo $postcode; ?>" >
                               <input type="text" class="form-control inputfield" style="margin-left:0%; width:45%;" data-toggle="tooltip"  title="Please enter your School." name="schoolName" id="schoolName" placeholder="School Name*" value="<?php echo $schoolOrgName; ?>" >
                            </div>
                             <div class="form-group form-inline">
                            ...
                            <div class="form-group form-inline text-left">
                             ...
                             <a href="#" style="margin-left:3.5em; color:#000;" data-toggle="tooltip" data-placement="top" title="If you are a student, teacher  please contact your School administrator to get access to this product.">Not a School admin? </a> 
