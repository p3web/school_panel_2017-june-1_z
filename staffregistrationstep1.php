...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if(isset($_POST["check_anonymous"]) && $_POST["check_anonymous"]){
           ...
           <h3  class="text-center">REGISTRATION</h3>
                ...
                <div class="col-sm-12 text-center" style="background-color:#FFF; margin-bottom:30px; margin-top:2em; padding-bottom:30px;">
                       ...
                       <form action="" method="post" >
                            ...
                            <span style=" clear:both; float:left; margin-left:3em;"><input type="checkbox" name="check_anonymous">I want to be anonymous
                            </span>
