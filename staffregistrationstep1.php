...
if(isset($_SESSION['s'])){ $orgName = $_SESSION["s"];}
                       ...
                       <form action="" method="post" >
                            ...
                            <div class="form-group form-inline">
                             ...
                             <input type="text" class="form-control inputfield" style="margin-left:1.5%; width:45%; background-color:#6f9693; color:#000;" name="username" id="username" placeholder="Username*" disabled value="<?php echo $email; ?>"  >
                               <input type="text" class="form-control inputfield" style="margin-left:0%; width:45%; background-color:#6f9693;" name="orgname"  id="orgname" placeholder="Organisation*" disabled value="<?php echo $orgName; ?>" >
                            </div>
                            <div class="form-group form-inline" >
                            ...
                            <div class="form-group form-inline">
                               ...
                               <select required class="form-control inputfield" style="float:left; margin-left:5.5%; width:45%;" name="option" id="option">
                            ...
                            <span style=" clear:both; float:left; margin-left:3em;">
								<label>
									<input type="radio" name="check_anonymous" value="false" checked > My team admin can see my information on  this website
								</label>
								<br>
								<label style="margin-left: -83px;">
									<input type="radio" name="check_anonymous" value="true"  style="margin: 0%" > please keep my information as anonymous
								</label>
                            </span>
