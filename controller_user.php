...
=======
            ...
            user_profile::edit_teacher_profile($_REQUEST['email'],$_REQUEST['firstname'],$_REQUEST['lasttname'],$_REQUEST['gender'],$_REQUEST['department'],$_REQUEST['Self'],$_REQUEST['Father'],$_REQUEST['Mother'],$_REQUEST['f_Grandfather'],$_REQUEST['f_GrandMother'],$_REQUEST['m_Grandfather'],$_REQUEST['m_GrandMother']);
>>>>>>> e1239fba462841e40c4d47613dc439a92857dc5d
            user_profile::edit_age_user($_REQUEST['age'],$_REQUEST['email'],4);
            echo '<script type="text/javascript">';
            echo 'alert("Edit profile successful.");' ;
